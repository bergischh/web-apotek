            ...
            @foreach ($medicines as $item)
                <tr>
                    ...
                    <td class="d-flex justify-content-center">
                        <div onclick="edit({{ $item['id'] }})" class="btn btn-primary me-3" style="cursor: pointer">Tambah Stock</a>
                    </td>
                </tr>
            @endforeach
        </tbody>
                ...
                <form method="POST" id="form-stock">
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button for="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
@push('script')
    <script type="text/javascript">
        ...
        function edit(id) {
            //simpan utl route yang edit kedalam variabel url, untuk path parameternya diisi dengan path dinamis versi js
